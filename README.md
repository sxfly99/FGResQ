...
<div style="font-family: sans-serif; margin-bottom: 2em;">
    ...
    <ul style="list-style-type: none; padding-left: 0;">
        <li style="margin-bottom: 0.8em;">
            <strong>[2026-05-14]</strong> 🔥🔥🔥 Our method is utilized for evaluation in <a href="https://www.sciencedirect.com/science/article/pii/S0167865526001686">Post-Processing Ensemble Framework for Balancing Fidelity and Perception in Super-Resolution</a>, Kim et al. (Pattern Recognition Letters, 2026). The authors highlight that: "Both cases demonstrate a reliable selection mechanism guided by FGResQ."
        </li>
        <li style="margin-bottom: 0.8em;">
